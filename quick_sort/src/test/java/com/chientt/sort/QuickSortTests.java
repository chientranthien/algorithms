...
//    @Test
    public void shouldSortAsc() {
        Integer input[] = new Integer[]{3, 1, 6, 17, 5, 1,8};
        Integer expectation[] = new Integer[]{1, 1, 3, 5, 6,8, 17};
...
//    @Test
    ...
    public void testPivot() {
        Integer input[] = new Integer[]{3, 6,17};
        QuickSort<Integer> arraySort = new QuickSort();

        int pivot = arraySort.pivot(input, 0, input.length - 1, (a, b) -> a > b);
        int pivot = arraySort.pivot(input, 0, input.length - 1, (a, b) -> a > b);
